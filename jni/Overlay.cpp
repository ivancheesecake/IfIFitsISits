...
//ibalik sa CaptureActivity
JNIEXPORT void JNICALL Java_com_cheesecake_ififitsisits_CaptureActivity2_Overlay(JNIEnv*, jobject, jlong src, jlong ovr);
...
JNIEXPORT void JNICALL Java_com_cheesecake_ififitsisits_CaptureActivity2_Overlay(JNIEnv*, jobject, jlong src, jlong ovr){
	...
	for(int y=0; y<img.rows; y++){
		for(int x=0; x<(int)img.cols/2; x++){
